...
parser.add_argument('--image_path', default='../datasets/coco128/images/train2017', type=str, help="path of images")
parser.add_argument('--label_path', default='../datasets/coco128/labels/train2017', type=str, help="path of labels .txt")
